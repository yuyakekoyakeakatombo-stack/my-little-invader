...
const MUTATIONS = [
  ...
  ['おばけが動かない（ただ揺れているだけに戻る）',
   "  const GHOST_RISE_SPD  = 0.7;", "  const GHOST_RISE_SPD  = 0;", 'caught'],
  ['おばけが昇りすぎてヘッダーに掛かる',
   "  const GHOST_RISE_SPD  = 0.7;", "  const GHOST_RISE_SPD  = 3;", 'caught'],
  ['ためを置かずにいきなり昇りはじめる',
   "  const GHOST_RISE_FROM = 8;", "  const GHOST_RISE_FROM = 0;", 'caught'],
  ['点滅せずに消える',
   "  const GHOST_FADE_LAST = 12;", "  const GHOST_FADE_LAST = 0;", 'caught'],
